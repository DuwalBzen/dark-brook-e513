...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/dark-brook-e513
```

A live public deployment of this template is available at [https://dark-brook-e513.templates.workers.dev](https://dark-brook-e513.templates.workers.dev)
